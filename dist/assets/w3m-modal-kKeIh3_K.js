import{c6 as k,cr as le,bD as c,bF as pe,bp as v,bq as V,bt as f,bu as g,bv as d,bs as l,b$ as $,bO as H,c0 as u,br as me,bK as w,bx as B,bZ as U,cn as fe,cc as F,bH as K,c3 as A,bS as M,bA as we,bE as E,c8 as z,ck as oe,b_ as be,bz as ce,cs as ge,ct as ye}from"./index-Bj0FSH5A.js";import{P as D}from"./index-IEQGPDLg.js";import{S as ve}from"./SwapController-Bt3fRBz8.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
