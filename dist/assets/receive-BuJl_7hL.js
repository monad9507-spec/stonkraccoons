import{bp as k,bq as v,br as N,bs as x,bt as $,bu as C,bv as u,bK as c,bE as h,bZ as m,b_ as b,bz as R,b$ as A,bI as I,bJ as S,bD as T,bM as _,c0 as f}from"./index-DHglr2M2.js";const E=k`
  button {
    width: 100%;
    display: flex;
    align-items: center;
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${A(b.state.themeVariables["--apkt-qr-color"]??b.state.themeVariables["--w3m-qr-color"])}
      ...
      .networkImages=${n}
    ></wui-compatible-network>`}onReceiveClick(){T.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(_.copyToClopboard(this.address),h.showSuccess("Address copied"))}catch{h.showError("Failed to copy")}}};d.styles=O;w([f()],d.prototype,"address",void 0);w([f()],d.prototype,"profileName",void 0);w([f()],d.prototype,"network",void 0);d=w([$("w3m-wallet-receive-view")],d);export{d as W3mWalletReceiveView};
